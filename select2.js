...
(function ($, undefined) {
   ...
   */
    ...
    MultiSelect2 = clazz(AbstractSelect2, {
        ...
        // multi
        updateSelection: function (data, _update) {
            ...
            if(!_update) {
                ...
                if(this.selection.find(".select2-search-choice:last div").text() ===  data[0].text)
        ...
        // multi
        data: function(values, triggerChange, _update) {
            if(_update) values = values[0];
            ...
            if (arguments.length === 0) {
                ...
                if (!values) { values = []; }
                if(_update) {
                    ids = $.map(old, function(e) { return self.opts.id(e); });
                } else {
                    ids = $.map(values, function(e) { return self.opts.id(e); });
                }
                this.setVal(ids);
                this.updateSelection(values, _update);
    ...
    $.fn.select2 = function () {
       ...
       var _update = args[2] === 'update' ? true : false;
        ...
        this.each(function () {
            if (args.length === 0 || typeof(args[0]) === "object") {
                ...
                if (method === "container") {
                    ...
                    if(_update) {
                        value = select2[method].call(select2, args.slice(1), undefined, _update);
                    } else {
